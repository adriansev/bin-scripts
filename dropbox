...
# This file is part of nautilus-dropbox 2025.05.20.
#
...
def download_file_chunk(url, buf):
    ...
    opener.addheaders = [('User-Agent', "DropboxLinuxDownloader/2025.05.20")]
...
it's installed, and the Dropbox command-line interface.
    ...
    console_print("Dropbox command-line interface version: 2025.05.20")
